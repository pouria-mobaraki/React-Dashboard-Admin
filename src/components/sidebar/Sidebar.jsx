     ...
     <div className="sidebarWrapper">
      <div className="sidebarMenu">
        ...
        <ul className="sidebarList">
          <li className="sidebarList_item active"><LineStyle className='sidebarIcon'/> Home</li>
      ...
      <div className="sidebarMenu">
        ...
        <ul className="sidebarList">
          <li className="sidebarList_item "><PermIdentity className='sidebarIcon'/> Users</li>
          <li className="sidebarList_item"><Storefront className='sidebarIcon'/> New User</li>
          <li className="sidebarList_item"><AttachMoney className='sidebarIcon'/> Products</li>
